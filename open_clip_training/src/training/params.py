...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to ADE150 masks for conducting zero shot evaluation.",
    )
    parser.add_argument(
        "--logs",
        type=str,
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="contrastive learning by predicting the output of frozen CLIP visual encoder",
    )
    parser.add_argument(
        "--grad-checkpointing",
        default=False,
